...
axios
  .get('https://gaphy-app.herokuapp.com/' || 'http://localhost:3000/gifs')
  .then(response => {
...
editSubmit.addEventListener('click', e => {
  ...
  axios
    .put(
      `https://gaphy-app.herokuapp.com/${currentlyEditing}` ||
        `http://localhost:3000/gifs/${currentlyEditing}`,
      {
        name,
        url
      }
...
submit.addEventListener('click', e => {
  ...
  axios
    .post('https://gaphy-app.herokuapp.com/' || 'http://localhost:3000/gifs', {
      name,
      url
    })
    .then(resp => {
